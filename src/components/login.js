  ...
  return (
    <div className="">
      ...
      <div className={` p-2 px-3 xl:p-4 xl:px-7 2xl:px-14 w-full`}>
        <div className="text-2xl xl:text-5xl py-5 font-sohne">Login with your username</div>
        <form>
          <div className="flex overflow-hidden px-2 py-1 justify-between">
            <input
              className="text-base font-sohne xl:text-2xl bg-ldinput border-lddblue border-0 border-b-4  text-white flex-grow px-2 box-content h-8 w-8 xl:h-16 xl:w-16"
              type="input"
              id="username"
          ...
          <div className="flex font-sohne items-center pt-5 px-1 py-3 xl:pt-10 xl:px-2 xl:py-6 space-x-4 mx-auto submission">
            {loginButton ? (
            <button
              type="submit"
              id="submission"
            ...
            <button
              type="submit"
              id="clear"
              className="bg-ldred mx-auto font-sohne text-white text-base xl:text-2xl px-2 py-1 xl:px-4 xl:py-2 xl:w-1/2 "
